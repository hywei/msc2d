...
bool MeshIO::OpenObjFile(const std::string& filename)
{
  ...
  vert_vec.clear(); vert_vec.resize(nVertex);
  face_vec.clear(); face_vec.resize(nFace);
  ...
  m_mesh.p_Info->m_nVertices = nVertex;
  m_mesh.p_Info->m_nFaces = nFace;
